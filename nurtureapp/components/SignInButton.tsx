...
export default function SignInButton({ text }) {
    return (
        <button className="relative animate-bounce inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded-full hover:bg-white group">
